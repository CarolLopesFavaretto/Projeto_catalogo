...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.catalogointerno.Projeto.Catalogo.controller"))
    ...
    public static ApiInfo metadata() {
        return new ApiInfoBuilder()
                .title("API - Catalogo Interno")
                .description("Projeto API Spring - Catalogo Interno")
                .version("1.0.0")
                .license("Apache License Version 2.0")
                .licenseUrl("https://github.com/CarolLopesFavaretto")
                .contact(contact())
                .build();
    }
    private static Contact contact() {
        return new Contact("Caroline Favaretto",
                "https://github.com/CarolLopesFavaretto",
                "carolinelopesrdg@hotmail.com");
    }
